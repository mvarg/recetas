...
class User extends \UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'createdAt', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'updatedAt');
        }
